  ...
  return (
    <div className='mx-auto max-w-4xl p-6'>
      ...
      <div className='text-center'>
        <Link href='/ranking'>
          <button className='w-full rounded-md bg-green-500 py-4 text-3xl font-bold text-white shadow-md hover:bg-green-600 focus:outline-none focus:ring-2 focus:ring-green-300'>
            回答を開始
          </button>
        </Link>
      </div>
